    ...
    emptyScreen = () => {
        return (
            <div className="flex-grow flex flex-col justify-center items-center">
                ...
                <span className="font-bold mt-4 text-xl px-1 text-gray-400">La corbeille est vide</span>
            </div>
        );
    }
        ...
        return (
            <div className="w-full h-full flex flex-col bg-ub-cool-grey text-white select-none" style={{ backgroundColor: '#272a34' }}>
                <div className="flex items-center justify-between w-full bg-ub-warm-grey bg-opacity-40 text-sm">
                    ...
                    <div className="flex">
                        <div className="border border-black bg-black bg-opacity-50 px-3 py-1 my-1 mx-1 rounded text-gray-300">Restaurer</div>
                        <div onClick={this.emptyTrash} className="border border-black bg-black bg-opacity-50 px-3 py-1 my-1 mx-1 rounded hover:bg-opacity-80">Vider</div>
                    </div>
                </div>
                {
                    (this.state.empty
